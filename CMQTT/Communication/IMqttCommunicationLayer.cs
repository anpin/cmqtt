...
namespace CMQTT.Communication
{
    ...
    /// <summary>
    /// Delegate event handler for MQTT client socket disconnected event
    /// </summary>
    /// <param name="sender">The object which raises event</param>
    /// <param name="e">Event args</param>
    public delegate void MqttClientDisconnectedEventHandler(object sender, MqttClientDisconnectedEventArgs e);
    ...
    public interface IMqttCommunicationLayer
    {
        ...
        /// </summary>
        event MqttClientDisconnectedEventHandler ClientDisconnected;
    }
}
