...
namespace CMQTT.Managers
{
       ...
       public List<MqttSubscription> GetSubscriptions(string topic, byte qosLevel)
        ...
        public MqttSubscription GetSubscription(string topic, string clientId)
        {
            lock (this.subscribers)
            {
                ...
                //return this.subscribers.Where(ss => new Regex(ss.Key).IsMatch(topic)).Select
            }
        }
    ...
    public class MqttSubscription
    {
        ...
        public MqttSubscription(string clientId, string topic, byte qosLevel, MqttClient client)
        {
